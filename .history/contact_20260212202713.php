...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $headers = "From: SKRNCH Studio <webmaster@skrnchstudio.com>\r\n";
    ...
    if (!empty($email)) {
        ...
        $auto_headers = "From: SKRNCH Studio <orders@skrnchstudio.com>\r\n";
        $auto_headers .= "Reply-To: support@skrnchstudio.com\r\n";
