...
$username = "YOUR_DB_USERNAME"; // From DirectAdmin MySQL Management
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $headers = "From: webmaster@skrnchstudio.com\r\n";
    ...
    mail($email, $auto_subject, $auto_body, "From: orders@skrnchstudio.com");
